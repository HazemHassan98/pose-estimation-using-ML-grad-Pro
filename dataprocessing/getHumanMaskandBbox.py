...
frame_dir = 'E:\My Stuff\Engineering\Year 4\Grad Project\wifiperson-master' + file_name + '/'
frames = glob.glob(frame_dir + '*.mat')
frame_num = len(frames)/2
 
cap = cv2.VideoCapture('E:\My Stuff\Engineering\Year 4\Grad Project\wifiperson-master\datacollectioncode\videowithtimestamp'+ file_name + '.avi')
